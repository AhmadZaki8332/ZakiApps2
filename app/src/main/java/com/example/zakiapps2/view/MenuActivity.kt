...
@Composable
fun MakananGridActivity(navController: NavController) {
    MakananGridScreen(navController)
}


@Composable
fun MakananGridScreen(navController: NavController) {
    Scaffold(
        bottomBar = {
        ...
        Column(
            ...
            MenuBody(navController = navController, daftarMakananGrid = daftarMakananGrid)
        }
    }
}